                ...
                <div class="col-lg-3 col-md-4">
                    <div class="profile">
                        <div class="profile-name">
                            <span class="name">MARY D. DAVIS</span><br>
                            <span class="job">Model & Actress</span>
                        </div>
                        ...
                        <ul class="profile-information">
                            <li></li>
                            <li><p><span>Name:</span> Mary D. Davis</p></li>
                            <li><p><span>Birthday:</span> 06 December 1987</p></li>
                            <li><p><span>Job:</span> Model & Actress</p></li>
                            <li><p><span>Email:</span> henry@domain.com</p></li>
                            <li><p><span>Skype:</span> marrydavis</p></li>
                        </ul>
                        <div class="col-md-12">
                ...
                <div id="ajax-tab-container" class="col-lg-9 col-md-8 tab-container">
                        ...
                        <div class="col-md-12">
                            <div id="content" class="panel-container">
                                ...
                                <div id="home">
                                    ...
                                    <!-- My Services Section -->
                                    <div class="row">
                                        <section class="gallery line graybg col-md-12 padding_50 padbot_50">
                                            <div class="section-title bottom_30"><span></span><h2>Photo Gallery</h2></div>
                                            <div id="widget-gallery">
                                                <!-- a photo -->
                                                <div class="cbp-item cbp-lightbox">
                                                    <a href="images/gallery/01.jpg" class="cbp-lightbox">
                                                        <figure>
                                                ...
                                                <!-- a photo -->
                                                <div class="cbp-item cbp-lightbox">
                                                    <a href="images/gallery/02.jpg" class="cbp-lightbox">
                                                        <figure>
                                                ...
                                                <!-- a photo -->
                                                <div class="cbp-item cbp-lightbox">
                                                    <a href="images/gallery/03.jpg" class="cbp-lightbox">
                                                        <figure>
                                                ...
                                                <!-- a photo -->
                                                <div class="cbp-item cbp-lightbox">
                                                    <a href="images/gallery/04.jpg" class="cbp-lightbox">
                                                        <figure>
                                                ...
                                                <!-- a photo -->
                                                <div class="cbp-item cbp-lightbox">
                                                    <a href="images/gallery/05.jpg" class="cbp-lightbox">
                                                        <figure>
                                                ...
                                                <!-- a photo -->
                                                <div class="cbp-item cbp-lightbox">
                                                    <a href="images/gallery/06.jpg" class="cbp-lightbox">
                                                        <figure>
                                                ...
                                                <!-- a photo -->
                                                <div class="cbp-item cbp-lightbox">
                                                    <a href="images/gallery/07.jpg" class="cbp-lightbox">
                                                        <figure>
                                                ...
                                                <!-- a photo -->
                                                <div class="cbp-item cbp-lightbox">
                                                    <a href="images/gallery/08.jpg" class="cbp-lightbox">
                                                        <figure>
                                    ...
                                    <div class="row">
                                        <section class="design-skills col-md-6 padding_60 padbot_50">
                                            <div class="section-title bottom_45"><span></span><h2>My Strengths</h2></div>
                                            <ul class="skill-list">
                                                <li>
                                                    <h3>Acting</h3>
                                                    <div class="progress">
                                                ...
                                                <li>
                                                    <h3>Walking Posture</h3>
                                                    <div class="progress">
                                                        <div class="percentage" style="width:60%;"></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <h3>Sense Of Style</h3>
                                                    <div class="progress">
                                        ...
                                        <section class="code-skills col-md-6 padding_60">
                                            <div class="section-title bottom_45"><span></span><h2>Language Skills</h2></div>
                                            <ul class="skill-list">
                                                <li>
                                                    <h3>English</h3>
                                                    <div class="progress">
                                ...
                                <div id="resume">
                                    ...
                                    <div class="row">
                                        <section class="education">
                                            <div class="section-title top_30"><span></span><h2>My Resume</h2></div>
                                            <div class="row">
                                                <!-- Working History -->
                                    ...
                                    <!-- Clients Section -->
                                    <div class="row">
                                        <section class="clients col-md-12 padding_15 padbot_30">
                                            <div class="section-title bottom_45"><span></span><h2>Filmography</h2></div>
                                            <!-- Movies -->
                                            <h3 class="table-title bottom_15">Movies</h3>
                                            <div class="table-responsive mat-table">
                                                <table class="table table-hover">
                                                    <colgroup> <col class="col-md-1"><col class="col-md-3"><col class="col-md-3"> <col class="col-md-4"> </colgroup>
                                                    <thead>
                                                    <tr>
                                                        <td>Year</td>
                                                        <td>Name</td>
                                                        <td>Role</td>
                                                        <td style="text-align: right;">Producer Company</td>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Sal Nealon</td>
                                                        <td style="text-align: right;">DC Comics</td>
                                                    </tr>
                                                    <tr>
                                                        <td>2016</td>
                                                        <td>Writer's Block</td>
                                                        <td>The Writer</td>
                                                        <td style="text-align: right;">New Line Cinema</td>
                                                    </tr>
                                                    <tr>
                                                        <td>2017</td>
                                                        <td>Get a Job</td>
                                                        <td>Roger Davis</td>
                                                        <td style="text-align: right;">Warner Bros. Entertainment</td>
                                                    </tr>
                                                    <tr>
                                                        <td>2017</td>
                                                        <td>Larry Crowne</td>
                                                        <td>Dean Tainot</td>
                                                        <td style="text-align: right;">Warner Bros. Cartoons</td>
                                                    </tr>
                                                    <tr>
                                                        <td>2017</td>
                                                        <td>Detachment</td>
                                                        <td>Richard Dearden</td>
                                                        <td style="text-align: right;">HBO Films</td>
                                                    </tr>
                                                    <tr>
                                                        <td>2017</td>
                                                        <td>Drive</td>
                                                        <td>Shannon</td>
                                                        <td style="text-align: right;">Warner Bros. Pictures</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <!-- Tv Series -->
                                            <h3 class="table-title top_45 bottom_15">Tv Series</h3>
                                            <div class="table-responsive mat-table">
                                                <table class="table table-hover">
                                                    <colgroup> <col class="col-md-1"><col class="col-md-3"><col class="col-md-3"> <col class="col-md-4"> </colgroup>
                                                    <thead>
                                    ...
                                    <div class="row">
                                        <section class="blog col-md-12 bottom_30">
                                            <div class="col-md-12 content-header">
                                                <div class="section-title top_30 bottom_30"><span></span><h2>Blog Posts</h2></div>
                                            </div>
                    ...
                    <footer>
                        <div class="footer col-md-12 top_30 bottom_30">
                            <div class="name col-md-4 hidden-md hidden-sm hidden-xs">Mary Davis.</div>
